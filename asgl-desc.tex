...
framework $AF = (Ar, att)$, answers to queries with respect to
grounded, complete, preferred, and stable semantics can be
...
exemplified with respect to grounded semantics in
...
is constrained not to be a subset of this extension.
